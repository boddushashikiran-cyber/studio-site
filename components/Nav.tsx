...
export default function Nav() {
  return (
    <header className="fixed left-0 right-0 top-0 z-40 flex items-center justify-between border-b border-line/40 bg-ink/80 px-6 py-6 backdrop-blur-md lg:px-12">
