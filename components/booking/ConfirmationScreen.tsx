  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      >
        {privateCode && (
          <Link
            href={`/booking-status/${privateCode}`}
            className="border border-amber px-6 py-3 font-mono text-xs tracking-widemono text-amber transition-colors hover:bg-amber hover:text-ink"
          >
            VIEW MY BOOKING
          </Link>
        )}
