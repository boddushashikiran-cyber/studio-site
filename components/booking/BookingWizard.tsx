...
export default function BookingWizard() {
  ...
  async function handleSubmit() {
    ...
    if (insertError) {
      // Postgres unique-violation code — someone booked this exact
      // slot between the user picking it and submitting.
  ...
  if (confirmed && date && timeSlot) {
    return <ConfirmationScreen date={date} timeSlot={timeSlot} />;
  }
